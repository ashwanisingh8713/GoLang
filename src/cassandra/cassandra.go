...
import (
	"cassandra/db/table/address"
	"cassandra/db/table/cart_item"
	"cassandra/db/table/category"
	"cassandra/db/table/seller"
	"cassandra/db/table/sub_category"
	"cassandra/db/table/user"
)
