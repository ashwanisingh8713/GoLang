...
func AppBar() []interface{} {
	...
	var titleValue = properties.Value{TextColor: titleColor, Label: "App Bar Title ", TextSize: 25, Weight: 700, FontStyle: font.FontStyleType.String(font.MontBold)}
	//var borderColor = properties.BackgroundColor{Hue: 0, Saturation: 0.0, Lighting: 0.0, Alpha: 1.0}
	var titleTvModifier = properties.Modifier{}
